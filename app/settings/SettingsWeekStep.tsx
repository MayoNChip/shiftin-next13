...
import { INITIAL_FORM_DATA } from "@/lib/settings";

type Props = typeof INITIAL_FORM_DATA & {
  loading: boolean;
};
  ...
  return (
    <FromWrapper title="Work Week Setup">
      ...
      <Button
        ...
        className="w-1/2"
        onClick={() => {
          handleSaveWeekWorkDays(
            data.weekWorkDays.map((day) => {
              return { workDayId: day.id, active: day.active };
            })
          );
        }}
      >
